      ...
      <div class="row">
         ...
         <div class="col-7">
            <h2 style="margin-top: 10px;">Quem é Carla Beloto?</h2>
               <p style="font-size: 23px; text-align: justify;">A profissional Carla Beloto, é formada em Letras: Português e em inglês, tendo três especializações: em
      ...
      <div class="row">
         <div class="col-9">
               ...
               <p style="font-size: 25px; text-align: justify; margin-top: 100px;">
                  A escola de redação oferece aulas presenciais e remotas
               </p>
               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-6">
                        ...
                        <p>
                           Email: choreenquantopode@email.com
                        </p>
         ...
         <div class="col-3" style="margin-top: 20px;">
            <p>
               <img src="img/logoRedonda.png" alt="teste"
